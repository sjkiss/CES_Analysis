...
ces93$market1<-Recode(ces93$PESE15, "1=1; 3=0.75; 5=0.25; 7=0; 8=0.5; else=NA", as.numeric=T)
ces93$market2<-Recode(ces93$MBSA2, "1=1; 2=0.75; 3=0.25; 4=0; 8=0.5; else=NA", as.numeric=T)
#checks
table(ces93$market1)
table(ces93$market2)
